...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      ...
      <Link style={{display: 'block'}} to={`${url}`}><Button color="inherit">Dashboard</Button></Link>
      {admin && <Box>
        <Link style={{display: 'block'}} to={`${url}/addDoctor`}><Button color="inherit">Add Doctor</Button></Link>
